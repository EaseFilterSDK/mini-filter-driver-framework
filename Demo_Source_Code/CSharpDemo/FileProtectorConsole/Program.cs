    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                fileProtectorFilter.FileChangeEventFilter = FilterAPI.FileChangedEvents.NotifyFileWasCreated | FilterAPI.FileChangedEvents.NotifyFileWasRenamed 
                    | FilterAPI.FileChangedEvents.NotifyFileWasDeleted | FilterAPI.FileChangedEvents.NotifyFileWasWritten | FilterAPI.FileChangedEvents.NotifyFileInfoWasChanged;

                //register the file change callback events.
                fileProtectorFilter.NotifyFileWasChanged += NotifyFileChanged;

                //Filter the callback file IO events, here get callback before the file was opened/created, and file was deleted.
                fileProtectorFilter.ControlFileIOEventFilter = (ControlFileIOEvents.OnPreFileCreate | ControlFileIOEvents.OnPreDeleteFile | ControlFileIOEvents.OnPreMoveOrRenameFile);
        ...
        {
            if (e.isOpenWithCreateOrOverWriteAccess)
            {
                Console.WriteLine("Creating new file:" + e.FileName + ",userName:" + e.UserName + ",processName:" + e.ProcessName + "\r\n");
        ...
        /// <summary>
        /// Fires this event before the file was move or renamed.
        /// </summary>
        static void OnPreMoveOrRenameFile(object sender, FileIOEventArgs e)
        {
            Console.WriteLine("OnPreMoveOrRenameFile:" + e.FileName + ",userName:" + e.UserName + ",processName:" + e.ProcessName + "\r\n");

            //you can block the file being moved or renamed here by returning below status.
            //e.ReturnStatus = NtStatus.Status.AccessDenied;
        }
    }
}
